 ...
 * data — never part of a saved `ChipDefinition`. Keyed by component id and
...
export interface EvaluateCircuitOptions {
  /** Values fed into the circuit's own boundary inputs (only meaningful for a chip's internals). */
